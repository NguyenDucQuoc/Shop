...
<html lang="en">
    <head>
        ...
        <link href="../view/public/admin/css/style.css" rel="stylesheet" />
        <link href="../view/public/admin/css/styles.css" rel="stylesheet" />
        <script src="../view/public/anmin/all.js" crossorigin="anonymous"></script>
    </head>
    <body class="sb-nav-fixed">
        ...
        <script src="../public/admin/js/simple-datatables@latest" crossorigin="anonymous"></script>
